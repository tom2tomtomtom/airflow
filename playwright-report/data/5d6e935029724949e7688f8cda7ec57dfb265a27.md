...
- Name: Authentication & Client Context >> Authentication Flow >> should handle logout
- Location: /Users/thomasdowuona-hyde/AIRWAVE_0525_CODEX/tests/e2e/auth.test.ts:121:9
...
============================================================
    at AuthHelper.logout (/Users/thomasdowuona-hyde/AIRWAVE_0525_CODEX/tests/e2e/helpers/auth-helper.ts:59:21)
    at /Users/thomasdowuona-hyde/AIRWAVE_0525_CODEX/tests/e2e/auth.test.ts:129:9
```
...
```yaml
- menu:
  - menuitem "Test User test@airwave.com":
    - paragraph: Test User
    - text: test@airwave.com
  - separator
  - menuitem "Settings"
  - menuitem "Logout"
```
