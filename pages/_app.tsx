...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  useEffect(() => {
    ...
    // Expose demo mode to window for testing
    (window as any).__NEXT_PUBLIC_DEMO_MODE = process.env.NEXT_PUBLIC_DEMO_MODE === 'true';
  }, []);
  ...
  return (
    <ErrorBoundary>
      <Head>
        ...
        <meta name="demo-mode" content={process.env.NEXT_PUBLIC_DEMO_MODE === 'true' ? 'true' : 'false'} />
