...
export interface ExportMetadata {
  ...
  compression: Record<string, unknown>$1
  originalSize: number;
...
export interface PlatformSpec {
  ...
  imageFormats: string[];
    ...
    naming: Record<string, unknown>$1
  pattern: string;
      maxLength: number;
      allowedChars: string;
    };
...
`;
  ...
  private initializeExportTemplates(): void {
    ...
    const socialTemplate: ExportTemplate = {
      ...
      category: 'social',
      format: Record<string, unknown>$1
  type: 'platform',
        packaging: 'zip',
        compression: 'lossy',
        qualitySettings: Record<string, unknown>$1
  ...
  includedAssets: ['image', 'video'],
      ...
      destination: Record<string, unknown>$1
  type: 'download' },
