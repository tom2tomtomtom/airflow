...
describe('StatusIndicator', () => {
  ...
  describe('text variant', () => {
    ...
    it('should show progress bar for in-progress status with progress prop', () => {
      renderWithTheme(<StatusIndicator status="in-progress" variant="text" progress={50} />);
    ...
    it('should not show progress bar for non in-progress status', () => {
      renderWithTheme(<StatusIndicator status="completed" variant="text" progress={50} />);
...
describe('CompletionStatus', () => {
  ...
  it('should hide percentage when showPercentage is false', () => {
    renderWithTheme(<CompletionStatus completed={5} total={10} showPercentage={false} />);
  ...
  it('should hide progress bar when showProgress is false', () => {
    renderWithTheme(<CompletionStatus completed={5} total={10} showProgress={false} />);
