...
export const GlobalSearch: React.FC<GlobalSearchProps> = ({ open, onClose }) => {
  ...
  const mockData: SearchResult[] = [
    ...
    {
      id: 'action-workflow',
      title: 'Start Brief Workflow',
      description: 'Upload a brief and create video content',
      type: 'action',
      icon: <PlayArrow />,
      action: () => router.push('/strategic-content')
    },
    {
      id: 'action-upload',
      title: 'Upload Assets',
      description: 'Add images, videos, and files to your library',
      type: 'action',
      icon: <CloudUpload />,
    ...
    },
    {
      id: 'page-templates',
      title: 'Templates',
      description: 'Video template library',
      type: 'page',
      icon: <VideoLibrary />,
      url: '/templates'
    },
    ...
    // Content
    {
      ...
      description: 'Q3 marketing campaign strategy',
      type: 'brief',
      icon: <Description />,
      url: '/briefs/summer-campaign',
      metadata: {
        date: '2 hours ago',
        status: 'completed',
    ...
    },
    {
      ...
      type: 'template',
      icon: <VideoLibrary />,
      url: '/templates/product-promo',
      metadata: {
        tags: ['product', 'promo', 'modern']
      }
    },
    {
      id: 'asset-logo',
