...
interface StrategicMotivationsTabProps {
  motivations: Motivation[];
  briefText: string;
  setBriefText: (text: string) => void;
  isGeneratingMotivations: boolean;
  handleGenerateMotivations: () => void;
  handleSelectMotivation: (id: string) => void;
}

const StrategicMotivationsTab: React.FC<StrategicMotivationsTabProps> = ({
  motivations,
  briefText,
  setBriefText,
  isGeneratingMotivations,
  handleGenerateMotivations,
  handleSelectMotivation,
}) => {
  return (
    <Box>
...
export default StrategicMotivationsTab;
