          ...
          {selectedCombinations.length > 0 && (
            <Box sx={{ mt: 3, p: 2, bgcolor: 'action.hover', borderRadius: 1 }}>
              ...
              <Typography variant="caption" color="text.secondary" display="block" gutterBottom>
                Estimated videos: {selectedCombinations.length * executionSettings.variations_per_combination * 3} 
                (3 platforms × {executionSettings.variations_per_combination} variations each)
              </Typography>
              <Button
                variant="contained"
