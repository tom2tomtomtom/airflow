...
const PublishingAnalytics: React.FC<PublishingAnalyticsProps> = ({
  ...
  const getPlatformIcon = (platform: string) => {
    switch (platform) {
      case 'facebook': return <FacebookIcon sx={{ color: platformColors.facebook }} />;
      case 'twitter': return <TwitterIcon sx={{ color: platformColors.twitter }} />;
      case 'linkedin': return <LinkedInIcon sx={{ color: platformColors.linkedin }} />;
      case 'instagram': return <InstagramIcon sx={{ color: platformColors.instagram }} />;
      case 'youtube': return <YouTubeIcon sx={{ color: platformColors.youtube }} />;
