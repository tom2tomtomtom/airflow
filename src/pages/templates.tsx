...
const mockTemplates = [
  ...
  },
  {
    ...
    platform: 'TikTok',
    aspectRatio: '9:16',
    description: 'Vertical video template for TikTok content',
    thumbnail: '/tiktok-video.jpg',
    ...
    contentType: 'Video',
    dimensions: '1080x1920',
    recommendedUsage: 'Short-form video content, trends, challenges',
    usageCount: 178,
    performance: {
      views: 15600,
      engagement: 9.3,
    ...
    dynamicFields: [
      {
        ...
        type: 'video',
        required: true,
        description: 'Main video content (9:16 ratio, max 60 seconds)'
      },
      {
        id: 'df2',
        name: 'Caption',
  ...
  },
  {
    ...
    platform: 'YouTube',
    aspectRatio: '16:9',
    description: 'Thumbnail template for YouTube videos',
  ...
  },
  {
    ...
    platform: 'LinkedIn',
    aspectRatio: '1:1',
    description: 'Professional template for LinkedIn posts',
    thumbnail: '/linkedin-post.jpg',
    ...
    recommendedUsage: 'Professional content, company updates, thought leadership',
    usageCount: 132,
    performance: {
      views: 7200,
      engagement: 4.5,
    ...
    dynamicFields: [
      {
        ...
        type: 'image',
        required: true,
        description: 'Main image (1:1 ratio)'
      },
      {
        id: 'df2',
        name: 'Headline',
        type: 'text',
        required: true,
        description: 'Post headline (max 70 characters)'
      },
      {
        id: 'df3',
        name: 'Body Text',
        type: 'text',
        required: true,
        description: 'Main post content (max 200 characters)'
      },
      {
        id: 'df4',
        name: 'Company Logo',
  ...
  },
  {
    ...
    recommendedUsage: 'DIY tutorials, product showcases, inspiration boards',
    usageCount: 98,
    performance: {
      views: 6300,
      engagement: 7.2,
    ...
    dynamicFields: [
      {
        ...
        type: 'image',
        required: true,
        description: 'Main pin image (2:3 ratio)'
      },
      {
        id: 'df2',
        name: 'Title',
        type: 'text',
        required: true,
        description: 'Pin title (max 60 characters)'
      },
      {
        id: 'df3',
        name: 'Description',
        type: 'text',
        required: false,
        description: 'Pin description (max 150 characters)'
      },
      {
        id: 'df4',
        name: 'Overlay Color',
        type: 'color',
        required: false,
        description: 'Color overlay for text area'
      }
    ],
    isCreatomate: true,
    creatomateId: 'crt-567890',
    isOwner: true,
    isShared: false
  },
];
