          ...
          <div className="bg-white shadow rounded-lg p-8">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-6">
                <strong>Effective Date:</strong> January 20, 2024
                <br />
              ...
              <section className="mb-8">
                ...
                <p>
                  You retain ownership of content you upload ("User Content"). By uploading content,
                ...
                <p>
                  Any feedback, suggestions, or ideas you provide become our property and may be
              ...
              <section className="mb-8">
                ...
                <p>
                  Paid features are available through subscription plans. By subscribing, you agree
                  to:
                </p>
                <ul className="list-disc pl-6 mb-4">
                ...
                <p>
                  We may modify pricing with 30 days' notice. Continued use after price changes
              ...
              <section className="mb-8">
                ...
                <p>
                  ...
                  . By using the Service, you consent to our data practices as described in the
                  Privacy Policy.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p>The Service integrates with third-party services. We are not responsible for:</p>
                <ul className="list-disc pl-6 mb-4">
              ...
              <section className="mb-8">
                ...
                <p>
                  ...
                  rules of [Arbitration Organization].
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p>
                  ...
                  upon posting. Continued use of the Service constitutes acceptance of modified
                  Terms.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p>
                  If any provision is found unenforceable, the remaining provisions shall continue
                  in effect.
                </p>
                ...
                <p>
                  You may not assign these Terms without our consent. We may assign our rights and
