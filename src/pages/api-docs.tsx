        ...
        <Box sx={{ p: 3 }}>
          <Paper sx={{ p: 4, mb: 3 }}>
            ...
            <Typography variant="body1" color="text.secondary" paragraph>
              Comprehensive documentation for all AIRWAVE API endpoints. This interactive documentation 
              allows you to explore and test API endpoints directly from your browser.
            </Typography>
            ...
            <Typography variant="body2" paragraph>
              ...
              • Base URL: <code>{process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3000'}</code>
