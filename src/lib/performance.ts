...
export function optimizePagination(options: PaginationOptions): { offset: number; limit: number } {
...
export function handleETag(req: NextApiRequest, res: NextApiResponse, data: any): boolean {
